...
- [ ] **Создание JPA сущностей**
  - [x] `Dataset.java` - Основная сущность датасета
  - [x] `DatasetColumn.java` - Сущность метаданных колонок
  - [x] `UploadJob.java` - Сущность отслеживания асинхронных задач
  - [x] Добавить правильные связи и индексы
